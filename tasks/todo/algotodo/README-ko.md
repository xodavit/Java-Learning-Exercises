...
-----------          |----------------------------------------------------------------|-------|-------------|
[Any Base to Any Base](../Java-Learning-Exercises/tasks/todo/algotodo/Conversions/AnyBaseToAnyBase.java)| [Coin Change](Dynamic%20Programming/CoinChange.java)|[Caesar](../Java-Learning-Exercises/tasks/todo/algotodo/ciphers/Caesar.java)|[Heap Sort](misc/heap_sort.java)|
[Any Base to Decimal](../Java-Learning-Exercises/tasks/todo/algotodo/Conversions/AnyBaseToDecimal.java)|[Egg Dropping](Dynamic%20Programming/EggDropping.java)|[Columnar Transposition Cipher](../Java-Learning-Exercises/tasks/todo/algotodo/ciphers/ColumnarTranspositionCipher.java)|[Palindromic Prime Checker](misc/PalindromicPrime.java)|
[Binary to Decimal](../Java-Learning-Exercises/tasks/todo/algotodo/Conversions/BinaryToDecimal.java)|[Fibonacci](Dynamic%20Programming/Fibonacci.java)|[RSA](../Java-Learning-Exercises/tasks/todo/algotodo/ciphers/RSA.java)|More soon...|
[Binary to HexaDecimal](../Java-Learning-Exercises/tasks/todo/algotodo/Conversions/BinaryToHexadecimal.java)|[Kadane Algorithm](Dynamic%20Programming/KadaneAlgorithm.java)|more coming soon...|
[Binary to Octal](../Java-Learning-Exercises/tasks/todo/algotodo/Conversions/BinaryToOctal.java)|[Knapsack](Dynamic%20Programming/Knapsack.java)|
[Decimal To Any Base](../Java-Learning-Exercises/tasks/todo/algotodo/Conversions/DecimalToAnyBase.java)|[Longest Common Subsequence](Dynamic%20Programming/LongestCommonSubsequence.java)|
[Decimal To Binary](../Java-Learning-Exercises/tasks/todo/algotodo/Conversions/DecimalToBinary.java)|[Longest Increasing Subsequence](Dynamic%20Programming/LongestIncreasingSubsequence.java)|
[Decimal To Hexadecimal](../Java-Learning-Exercises/tasks/todo/algotodo/Conversions/DecimalToHexaDecimal.java)|[Rod Cutting](Dynamic%20Programming/RodCutting.java)|
