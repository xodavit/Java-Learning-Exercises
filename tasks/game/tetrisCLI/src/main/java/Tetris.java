        ...
        while (!isGameOver) {
            ...
            if (keyboardObserver.hasKeyEvents()) {
                ...
                if (event.getKeyCode() == KeyEvent.VK_LEFT)
                    ...
                    figure.right();
                    //переделал на пробел//Если  код клавиши равен 12 ("цифра 5 на доп. клавиатуре") - повернуть фигурку
                    //Если "пробел" - повернуть фигурку
                else if (event.getKeyCode() == KeyEvent.VK_SPACE) //12
                    figure.rotate();
                    //Если "стрелка вниз" - фигурка падает вниз на максимум
            ...
            Thread.sleep(333);  //пауза 333 миллисекунд - 1/3 секунды
        }
